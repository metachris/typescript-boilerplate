...
## Benchmarking with [benny](https://github.com/caderek/benny)

You can write simple [Benchmarks](https://caderek.github.io/benny):

```typescript
const b = require("benny");
const { greet } = require("../dist/tsc/main");
...
b.suite(
  ...
  b.cycle(),
  b.complete(),
  b.save({ file: "greet", version: "1.0.0" }),
  b.save({ file: "greet", format: "chart.html" })
);
```

Run the benchmarks with `yarn bench`, no separate compile step is necessary.
